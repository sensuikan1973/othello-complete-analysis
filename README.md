...
## 目次
<!--ts-->
   * [[WIP] オセロの完全解析、どうやるか? いくらかかるか?](README.md#wip-オセロの完全解析どうやるか-いくらかかるか)
      * [目次](README.md#目次)
      * [想定読者](README.md#想定読者)
      * [序論 「オセロ界におけるソフト事情の概要」](README.md#序論-オセロ界におけるソフト事情の概要)
         * [ここで言う「オセロ」の定義](README.md#ここで言うオセロの定義)
         * [そもそも何のために完全解析したいの?](README.md#そもそも何のために完全解析したいの)
         * [現在の解析状況](README.md#現在の解析状況)
         * [ソフトの活用 〜世界大会を例に〜](README.md#ソフトの活用-世界大会を例に)
         * [用語定義](README.md#用語定義)
      * [本論 「完全解析を考える」](README.md#本論-完全解析を考える)
         * [あああ](README.md#あああ)
         * [使うソフトウェアは?](README.md#使うソフトウェアは)
         * [方法/構成 X つ](README.md#方法構成-x-つ)
            * [A: お手元のマシン](README.md#a-お手元のマシン)
            * [B: スパコン](README.md#b-スパコン)
            * [C: Compute Engine Service](README.md#c-compute-engine-service)
            * [D: Map Reduce Service](README.md#d-map-reduce-service)
            * [まとめ](README.md#まとめ)
         * [学習データの活用](README.md#学習データの活用)
            * [個人が携帯可能なものとして](README.md#個人が携帯可能なものとして)
            * [オンラインサービスとして](README.md#オンラインサービスとして)
      * [結論](README.md#結論)
      * [参考](README.md#参考)
         * [Othello Software](README.md#othello-software)
         * [Others (Blog, Slide, Paper and so on)](README.md#others-blog-slide-paper-and-so-on)
            * [Othello](README.md#othello)
            * [Checker](README.md#checker)
            * [Chess](README.md#chess)
            * [Shogi](README.md#shogi)
            * [Go](README.md#go)
