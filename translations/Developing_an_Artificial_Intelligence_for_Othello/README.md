...
上記のリストには、明示的なプログラミング(つまりゲームの知識をアルゴリズムとして表現すること)が必要なアルゴリズムを含んでいます。
その他のアルゴリズムは、既知のゲームデータや結果(教師あり学習)から学習する能力を有していたり、最良の戦術や戦略自体を発見する学習(教師なし学習)も能力を有していたりする点に注意して下さい。
