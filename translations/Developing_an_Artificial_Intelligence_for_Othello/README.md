...
<!-- Added by: runner, at: Sat Nov 28 23:20:11 UTC 2020 -->
...
* AI は、推論や学習の観点から、人間の脳の能力を模倣できるプログラムあるいはアルゴリズムだとが一般的に認識されています。<br/>
...
上記のリストには、明示的なプログラミング(つまりゲームの知識をアルゴリズムとして表現すること)が必要なアルゴリズムを含んでいます。<br/>
