...
【目次】
<!--ts-->
   * [<a href="https://ocasile.pagesperso-orange.fr/neurone.htm" rel="nofollow">Developing an Artificial Intelligence for Othello/Reversi</a> の日本語訳](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#developing-an-artificial-intelligence-for-othelloreversi-の日本語訳)
      * [前置き](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#前置き)
      * [詳細に入る](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#詳細に入る)
         * [評価関数](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#評価関数)
         * [Minimax](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#minimax)
         * [αβ](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#αβ)
         * [Negascout](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#negascout)
         * [Prob-cut](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#prob-cut)
         * [Neural networks](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#neural-networks)
         * [Neural networks の種類](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#neural-networks-の種類)
         * [特徴エンジニアリング](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#特徴エンジニアリング)
         * [訓練データ](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#訓練データ)
         * [学習不足と過学習](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#学習不足と過学習)
         * [正則化と一般化](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#正則化と一般化)
         * [モンテカルロ木探索と UCB](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#モンテカルロ木探索と-ucb)
         * [ビットボード](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#ビットボード)
         * [マルチスレッド](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#マルチスレッド)
         * [ベクトル化](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#ベクトル化)
      * [参考文献](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#参考文献)
         * [<a href="https://ndownloader.figshare.com/files/12092954" rel="nofollow">A world-championship-level Othello program</a>](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#a-world-championship-level-othello-program)
         * [<a href="https://skatgame.net/mburo/ps/compoth.pdf" rel="nofollow">An evaluation function for Othello based on statistics</a>](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#an-evaluation-function-for-othello-based-on-statistics)
         * [<a href="http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.16.9096" rel="nofollow">The evolution of Strong Othello programs</a>](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#the-evolution-of-strong-othello-programs)
         * [<a href="https://skatgame.net/mburo/ps/improve.pdf" rel="nofollow">Experiments with Multi-ProbCut and a new High-Quality evaluation Function for Othello</a>](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#experiments-with-multi-probcut-and-a-new-high-quality-evaluation-function-for-othello)
         * [<a href="https://skatgame.net/mburo/ps/book.pdf" rel="nofollow">Toward Opening Book Learning</a>](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#toward-opening-book-learning)
         * [<a href="https://onlinelibrary.wiley.com/doi/abs/10.1111/j.1467-8640.1996.tb00252.x" rel="nofollow">Knowledge-based feature discovery for evaluation functions</a>](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#knowledge-based-feature-discovery-for-evaluation-functions)
         * [<a href="https://docplayer.net/54026159-Linear-versus-non-linear-learning-in-the-context-of-othello.html" rel="nofollow">Linear versus Non-Linear Learning in the Context of Othello</a>](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#linear-versus-non-linear-learning-in-the-context-of-othello)
         * [<a href="https://ocasile.pagesperso-orange.fr/www.xiaotu.com/pub/ChonS05a.pdf" rel="nofollow">Observing the Evolution of Neural Networks, Learning to Play the Game of Othello</a>](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#observing-the-evolution-of-neural-networks-learning-to-play-the-game-of-othello)
         * [<a href="http://proceedings.mlr.press/v22/kaufmann12/kaufmann12.pdf" rel="nofollow">On Bayesian Upper Confidence Bounds for Bandit Problems</a>](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#on-bayesian-upper-confidence-bounds-for-bandit-problems)
      * [ツーリング　](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#ツーリング)
         * [プログラミング](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#プログラミング)
         * [深層学習](translations/Developing_an_Artificial_Intelligence_for_Othello/README.md#深層学習)
...
しかしながら、そのようなライブラリは十分ではありません。
主な理由は、全手番の局面に対する最終スコアが常に分かっているとは限らないためです。
...
埋め込み層の係数は数が非常に多いですが、訓練時に計算されます。
動的に入力の次元数を削減することで、埋め込み層は、最初の密な隠れ層の乗算数を制限します。
これは、事前に計算された高密度層が最初の層にあると見なすことができます。
したがって、ニューロン 1 つの層と、そこに紐づくコストのかかる行列乗算を基本的に節約できます。

ニューラルネットワークのもう一つの側面は、深さ(隠れ層の数)と幅(各層のニューロン数)です。
最初は、解決する問題は複雑であるという信念に駆られて、ネットワークに多くの層と多くのニューロンを配置したくなりがちです。
そのアプローチは、過学習に繋がります。
正しいアプローチは、最も単純なネットワークから始めて結果を確認し、レイヤーのニューロン数を増やして精度を向上させていくことです。
...
過学習はとても簡単に検出できます。
というのも、ネットワークの精度が訓練データについては優れたスコアに達する一方で、検証データセットに対しては不十分なままになるからです。
